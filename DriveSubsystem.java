...
public class DriveSubsystem extends SubsystemBase {
  ...
  // The gyro sensor
  private final WPI_Pigeon2 m_gyro = new WPI_Pigeon2(Constants.pigeonid);
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("X Rotation", gyro3D().getX());
    SmartDashboard.putNumber("Y Rotation", gyro3D().getY());
    SmartDashboard.putNumber("Z Rotation", gyro3D().getZ());
  ...
  public Rotation3d gyro3D() {
    return new Rotation3d(m_gyro.getRoll(), m_gyro.getPitch(), m_gyro.getYaw());
  }
